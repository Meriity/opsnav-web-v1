                ...
                <tr key={item.id} className={`bg-white transition-all rounded-2xl ${hoverEffect ? 'hover:bg-sky-50' : ''}`}>
                  {columns.map((column, colIndex) => (
                    <td
                      ...
                      } ${colIndex === columns.length - 1 && !showActions && !status && !ot ? 'rounded-r-2xl' : ''}`}
                      style={{
                    ...
                    >
                      <div
                        className={`w-full overflow-hidden ${
                          column.key === 'property_address' || column.key === 'client_name' || column.key === 'dataentryby'
                  ...
                  {status && (
             <td className={`px-1 ${rowSpacing}`} style={{ width: '120px' }}>
  <div className="flex flex-wrap gap-1 max-w-[100px]">
    <button className="px-1 py-1 bg-green-500 text-white rounded text-xs shrink-0">S-1</button>
    <button className="px-1 py-1 bg-yellow-500 text-white rounded text-xs shrink-0">S-2</button>
    <button className="px-1 py-1 bg-red-500 text-white rounded text-xs shrink-0">S-3</button>
    <button className="px-1 py-1 bg-green-500 text-white rounded text-xs shrink-0">S-4</button>
    <button className="px-1 py-1 bg-red-500 text-white rounded text-xs shrink-0">S-5</button>
  </div>
</td>
