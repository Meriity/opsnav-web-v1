                ...
                <ul className="inline-flex text-sm">
                    <li className="mx-1">
                        <button
                            ...
                            className={`flex items-center cursor-pointer justify-center px-3 h-8 rounded-lg border ${currentPage === 1
                        ...
                        <li key={index} className="mx-1">
                            {page === '...' ? (
                                ...
                                <button
                                    ...
                                    className={`flex items-center cursor-pointer justify-center px-3 h-8 rounded-lg border ${currentPage === page
                    ...
                    <li className="mx-1">
                        <button
                            ...
                            className={`flex items-center cursor-pointer justify-center px-3 h-8 rounded-lg border ${currentPage === totalPages
                                ? 'bg-gray-200 text-gray-400 cursor-not-allowed'
                                : 'bg-white text-black border-gray-300 hover:bg-gray-100'
                                }`}
                        >
