  ...
  2026: {
    July: [
      ...
      },
      {
        ...
        type: "minor",
        category: "feature",
        title: "CRM Leads Workflow Overhaul & Print Media Table Cleanup",
        description: "Major usability pass across the CRM Leads table and Create/Edit Lead form, plus a cleaner allocation and address layout for Print Media View Orders.",
        updates: [
          {
            type: "feature",
            title: "Inline Notes Column",
            description: "Added a dedicated Notes column to the Leads table for quick note-taking.",
            details: "Users can now view and add lead notes directly from the table via a lightweight popover, without navigating into the full lead edit view. Supports Enter to submit and Shift+Enter for a new line.",
            icon: MessageSquare,
          },
          {
            type: "feature",
            title: "Lead Quick-Info Hover Card",
            description: "Hovering the Leads (name) column now surfaces key contact details instantly.",
            details: "A hover card shows email, phone, and created date at a glance, along with a clearly labelled 'Enquiry Description' block when present, without needing to open the full lead record.",
            icon: Eye,
          },
          {
            type: "ui_ux",
            title: "Custom Dropdown Menus for Temperature & Priority",
            description: "Replaced inconsistent native browser dropdowns with a custom-styled floating menu.",
            details: "Temperature and Priority can now be changed directly from the table using a consistent, properly positioned dropdown with color-coded options, fixing earlier mispositioning issues.",
            icon: Layout,
          },
          {
            type: "ui_ux",
            title: "Emoji-Only Temperature Column with Legend",
            description: "The Temperature column now shows a single emoji to save space, with wording preserved in the dropdown.",
            details: "Added an info icon above the table explaining what each Hot/Warm/Cold emoji means, keeping the column compact while staying clear.",
            icon: Sparkles,
          },
          {
            type: "ui_ux",
            title: "Simplified Status Column",
            description: "Reverted the Status column to a static badge, removing inline dropdown editing.",
            details: "Status changes are still fully supported through the Edit Lead modal, keeping the table view cleaner and less error-prone.",
            icon: Layout,
          },
          {
            type: "feature",
            title: "Two-Step Create/Edit Lead Wizard",
            description: "Redesigned the Lead form into a shorter, two-step flow.",
            details: "Contact and Enquiry Information are now merged into Step 1, with Internal Information in Step 2. 'Lead Created By' is shown on both steps, and the form is noticeably shorter to fill out.",
            icon: ArrowUpDown,
          },
          {
            type: "ui_ux",
            title: "Static Lead Status Display on Create",
            description: "Removed the non-functional dropdown arrow from Lead Status when creating a new lead.",
            details: "Since a new lead's status is always fixed to 'New Lead' at creation, the field now renders as a plain read-only label instead of a select with an arrow, avoiding confusion. The full status dropdown is still available when editing an existing lead.",
            icon: Eye,
          },
          {
            type: "improvement",
            title: "Refined Required Field Validation",
            description: "Only First Name, Last Name, Email, and Enquiry Type are now required.",
            details: "All other fields (Company, Phone, Enquiry Details, Lead Source, Temperature, Priority, Assigned To, and conditional reason fields) are optional, reducing friction when capturing a new lead.",
            icon: ShieldCheck,
          },
          {
            type: "bugfix",
            title: "Fixed 'Save and Create Another' Checkbox",
            description: "Resolved an issue where the modal closed instead of staying open for a new entry.",
            details: "The parent save handler was force-closing the modal on every save regardless of the checkbox. The modal now correctly stays open and resets for the next entry when 'Save and create another' is checked.",
            icon: Bug,
          },
          {
            type: "bugfix",
            title: "Fixed Premature Form Submission on 'Next'",
            description: "Clicking 'Next' on Step 1 no longer auto-submits the lead form.",
            details: "A DOM node reuse issue caused the 'Next' button to briefly become a submit button during the step transition, triggering an unintended save. The submit action is now driven entirely by explicit click handling, so the form only saves when the real submit button is clicked on Step 2.",
            icon: Bug,
          },
          {
            type: "ui_ux",
            title: "Conveyancing Terminology Update",
            description: "Renamed 'View Clients' and 'Archived Clients' to 'View Matters' and 'Archived Matters'.",
            details: "Updated the sidebar navigation and both table pages to use conveyancing-appropriate terminology, scoped strictly to the Conveyancing module.",
            icon: FolderOpen,
          },
          {
            type: "feature",
            title: "Selectable 'N/A' for Allocated User",
            description: "Print Media View Orders now supports explicitly unassigning an order.",
            details: "Added a dedicated 'N/A' option to the Allocated User dropdown so staff can deliberately unassign an order, rather than 'N/A' only ever appearing as a read-only placeholder label.",
            icon: Users,
          },
          {
            type: "ui_ux",
            title: "Print Media Table Layout Cleanup",
            description: "Removed the Client ID column and merged Unit with Delivery Address.",
            details: "The Unit and Delivery Address columns are now combined into a single 'Delivery Address' column (e.g. '4/ 12 Abc Avenue'), and the 'Type' column was renamed to 'Order Type' for clarity.",
            icon: Layout,
          },
        ],
        module: "CRM, Conveyancing, Print Media",
        severity: "Medium",
        status: "Released"
      },
      {
