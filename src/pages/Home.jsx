        ...
        >
          <div className="flex justify-between items-center mb-8">
            <div className="relative flex flex-col items-end">
              ...
              />
              <span className="text-[10px] text-gray-400 font-medium mt-2 leading-none">v5.0.1</span>
            </div>
            <button
              onClick={() => setIsMobileMenuOpen(false)}
            ...
            >
              <div className="relative flex flex-col items-end">
                <img
                  ...
                  className="h-10 sm:h-12 w-auto"
                />
                <span className="text-[10px] text-gray-400 font-medium leading-none">v5.0.1</span>
              </div>
            </motion.div>
