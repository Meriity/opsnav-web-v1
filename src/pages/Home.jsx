...
export default function Home() {
    return (
        <>
            <div className="relative min-h-screen bg-cover bg-center text-white" style={{ backgroundImage: "url('/screen1.png')" }}>
                <div className="absolute inset-0 bg-black/60" />

                <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 py-24 md:py-32">
                    <h1 className="text-3xl md:text-5xl font-bold pt-20 max-w-7xl">
                        Streamline Legal Ops with Precision. Scale Your Firm Without the Bottlenecks.
                    </h1>

                    <p className="mt-6 text-base md:text-lg max-w-4xl">
                        OpsNav brings control and clarity to your legal workflows — with centralized case tracking, automated task flows, and instant insights that keep your firm efficient and compliant.
                    </p>
                ...
                <div className="absolute top-4 right-4 z-20 flex gap-2">
                    <button className="bg-sky-500 hover:bg-sky-600 text-white px-4 py-2 rounded-md font-medium">
                        Login
                    </button>
                ...
                <div className="w-full flex flex-col items-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl w-full">
                        <div className="rounded-lg overflow-hidden shadow-lg">
                            <img src="/s3-1.png" alt="Law Firms" className="w-full h-64 object-cover" />
                        ...
                        <div className="rounded-lg overflow-hidden shadow-lg">
                            <img src="/s3-2.png" alt="Legal Ops Teams" className="w-full h-64 object-cover" />
                            <div className="bg-black text-white text-sm p-4">
                        ...
                        <div className="rounded-lg overflow-hidden shadow-lg">
                            <img src="/s3-3.png" alt="Firms Scaling Digital Ops" className="w-full h-64 object-cover" />
                            <div className="bg-black text-white text-sm p-4">
            ...
            <div className="mt-24 w-full flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl w-full justify-items-center">
                    <div className="bg-gray-100 p-6 rounded-lg text-center shadow w-full max-w-xs">
                        <img src="/s4-1.png" alt="No More Chaos" className="mx-auto mb-4 h-16" />
                        <p className="text-sm font-medium">
                            No more spreadsheets, emails, and tracking chaos
                        </p>
                    </div>
                    <div className="bg-gray-100 p-6 rounded-lg text-center shadow w-full max-w-xs">
                        <img src="/s4-2.png" alt="Collaboration" className="mx-auto mb-4 h-16" />
                        <p className="text-sm font-medium">
                            Enable seamless collaboration between staff and clients
                        </p>
                    </div>
                    <div className="bg-gray-100 p-6 rounded-lg text-center shadow w-full max-w-xs">
                        <img src="/s4-3.png" alt="Compliance" className="mx-auto mb-4 h-16" />
                        <p className="text-sm font-medium">
                            Stay on top of compliance with clear progress indicators
                        </p>
                    </div>
                    <div className="bg-gray-100 p-6 rounded-lg text-center shadow w-full max-w-xs">
                        <img src="/s4-4.png" alt="Work From Anywhere" className="mx-auto mb-4 h-16" />
                        <p className="text-sm font-medium">
                            Work from anywhere — securely hosted on GCP
                        </p>
                    </div>
                    <div className="bg-gray-100 p-6 rounded-lg text-center shadow w-full max-w-xs">
                        <img src="/s4-5.png" alt="Legal Built" className="mx-auto mb-4 h-16" />
                        <p className="text-sm font-medium">
