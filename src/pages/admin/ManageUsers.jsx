...
// Floating Background Elements (inspired by Dashboard)
...
// UsersPerPage dropdown component - Enhanced
      ...
      {ACCESS_MODULES.map((module) => {
        if (access.includes(module.value)) {
          ...
          return (
            ...
            >
              <ModuleIcon className="w-4 h-4" strokeWidth={2.5} />
            </button>
          );
        }
        return null;
...
// Stat Card Component (like Dashboard)
const StatCard = ({
  icon: Icon,
  title,
  value,
...
export default function ManageUsers() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#2E3D99]/5 to-[#1D97D7]/10 relative overflow-hidden">
        ...
        <main className="p-3 sm:p-4 md:p-6 max-w-7xl mx-auto">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <motion.div
              ...
              className="hidden lg:block rounded-2xl sm:rounded-3xl overflow-hidden bg-white/90 backdrop-blur-lg border border-white/50 shadow-xl hover:shadow-2xl transition-all duration-300"
            >
              <div className="p-4 sm:p-6">
                ...
                <div className="overflow-x-auto">
                  <Table
                    ...
                    // headerBgColor="bg-gradient-to-r from-[#2E3D99]/10 to-[#1D97D7]/10"
      ...
      {/* Modals - Enhanced with Dashboard styling */}
            ...
            >
              <div className="bg-white/95 backdrop-blur-lg rounded-2xl p-6 shadow-2xl border border-white/50 relative">
                ...
                <button
                  ...
                  className="w-full mt-6 bg-gradient-to-r from-[#2E3D99] to-[#1D97D7] text-white font-semibold py-3 px-4 rounded-lg hover:shadow-lg transition-all"
                >
                  Update User
                </button>
              </div>
