...
const formConfig = {
  ...
  wills: {
    fields: [
      { name: "voi", label: "VOI", type: "radio" },
      { name: "quote", label: "Quote", type: "radio" },
      { name: "sendWillForm", label: "Send will form", type: "radio" },
      { name: "draftWill", label: "Draft Will", type: "radio" },
      { name: "advice", label: "Advice", type: "radio" },
      { name: "signWill", label: "Sign Will", type: "radio" },
      { name: "willAcknowledgement", label: "Will acknowledgement", type: "radio" },
    ],
    noteGroups: [
      {
        id: "main",
        ...
        clientCommentKey: "clientComment",
        noteForClientKey: "noteForClient",
        fieldsForNote: ["voi", "quote", "sendWillForm", "draftWill", "advice", "signWill", "willAcknowledgement"],
      },
    ],
  },
  vocat: {
